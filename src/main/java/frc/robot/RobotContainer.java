...
public class RobotContainer {
    ...
    public BooleanSupplier isXon = driveController::getStartButton;
    public BooleanSupplier isRBumper = driveController::getRightBumper;
    public BooleanSupplier isLBumper = driveController::getLeftBumper;
